...
import { PracticeTestModuleComponent } from '../practice-test-list/components/practice-test-module/practice-test-module.component';

@Component({
  selector: 'app-grammer-excercise-list',
  templateUrl: './grammer-excercise-list.component.html',
  styles: [
  ]
})
export class GrammerExcerciseListComponent implements OnInit {
  ...
  constructor(public test: TestV3ApiService, private modalController: ModalControllerService) {
    this.practiceTestList = this.test.getTestList('GRAMMAR');
